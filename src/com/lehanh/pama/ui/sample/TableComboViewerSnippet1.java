...
import com.lehanh.pama.ui.Model;
...
public class TableComboViewerSnippet1 {
	...
	public static void main(String[] args) {
		...
		// create images
		testImage = ImageDescriptor.createFromFile(TableComboViewerSnippet1.class, 
			"in_ec_ov_success_16x16.gif").createImage();
		test2Image = ImageDescriptor.createFromFile(TableComboViewerSnippet1.class, 
			"in_ec_ov_warning_16x16.gif").createImage();
		test3Image = ImageDescriptor.createFromFile(TableComboViewerSnippet1.class, 
